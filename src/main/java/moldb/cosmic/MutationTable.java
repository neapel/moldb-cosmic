...
public class MutationTable {
	...
	public static void setup(Connection conn) throws SQLException {
		...
		s.executeUpdate("create table if not exists mutation (" +
				"chromosome text collate nocase," +
				"position integer," +
				"id text collate nocase," +
				"reference text collate nocase," +
				"alternative text collate nocase," +
				"coding integer," +
				"gene text collate nocase," +
				"strand text," +
				"count integer)");
	}
	...
	public static void read(Connection conn, String fileName, boolean isCoding) throws IOException,
			SQLException {
		...
		for (String line = reader.readLine(); line != null; line = reader.readLine()) {
			...
			for (String field : parts[7].split(";")) {
			...
			if(gene == null || strand == null) continue;
			ps.setString(7, gene);
